...
if __name__ == "__main__":
    ...
    with open(args.d[0]) as fp:
        ...
        plt.savefig(path_to_dir+"fig17_ACTORLoss" + differentiation_str)
        plt.close()
        ...
        plt.yscale("log")
        plt.savefig(path_to_dir+"fig18_CRITICLoss" + differentiation_str)
        plt.close()
        ...
        plt.xlabel("Episodes")
        plt.title("SAC_PL_KP Testing score")
        plt.ylabel("Avg Variation of Std of LU")
        plt.savefig(path_to_dir+"fig22_StdLU" + differentiation_str)
        plt.close()
        ...
        plt.savefig(path_to_dir+"fig20_AvgReturn" + differentiation_str)
        plt.close()

        plt.plot(learning_rate)
        plt.xlabel("Episodes")
        plt.ylabel("alpha")
        plt.savefig(path_to_dir+"fig19_alpha_" + differentiation_str)
        plt.close()

        plt.plot(error_links)
        plt.xlabel("Episodes")
        plt.title("SAC_PL_KP Testing score")
        plt.ylabel("Avg Variation of MLU")
        plt.savefig(path_to_dir+"fig21_MLU" + differentiation_str)
        plt.close()
