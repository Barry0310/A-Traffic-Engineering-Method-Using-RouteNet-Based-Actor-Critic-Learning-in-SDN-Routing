...
if __name__ == "__main__":
    ...
    dd_Eli = pd.DataFrame(columns=['OSPF', method, 'PPO_L_SP', 'LS', method+'+LS', 'PPO_L_SP+LS', 'Topologies'])
    dd_Janet = pd.DataFrame(columns=['OSPF', method, 'PPO_L_SP', 'LS', method+'+LS', 'PPO_L_SP+LS', 'Topologies'])
    dd_Hurricane = pd.DataFrame(columns=['OSPF', method, 'PPO_L_SP', 'LS', method+'+LS', 'PPO_L_SP+LS', 'Topologies'])
